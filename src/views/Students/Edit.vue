...
export default {
	...
	methods: {
		getStudentID (studentID) {
			axios.get('http://laravel-rest-api.test/api/students/' + studentID)
				.then(res => {
					console.log(res.data.data);
					this.model.students = res.data.data;
				})
		...
		updateStudent () {
			var mythis = this;
			axios.put('http://laravel-rest-api.test/api/students/' + this.$route.params.id, this.model.students)
				.then(res => {
